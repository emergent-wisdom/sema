...
def generate_tex():
    ...
    with open(rows_path, 'w') as f:
        ...
        for layer in layers_order:
            if layer not in taxonomy: continue
    ...
    with open(appendix_path, 'w') as f:
        ...
        total_cats = sum(len(taxonomy[layer]) for layer in taxonomy)
        
        f.write(f"The {len(patterns)} patterns are organized into {total_cats} categories across 4 fundamental layers:\n")
