...
def find_ghost_references():
    ...
    if target_handle:
        print(f"Scanning '{target_handle}' for unlinked handle mentions...\n")
    else:
        print(f"Scanning {len(content_map)} patterns for unlinked handle mentions...\n")
    ...
    if not target_handle:
        print(f"\nScan complete. Found unlinked handle mentions in {ghosts_found} patterns.")
