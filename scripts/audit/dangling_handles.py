...
The instance count matters for that decision, so it is reported. This repository's
current authoring policy uses three instances of explanation overhead as one
sufficiency rule; MintWhenFriction itself permits any rule declared before the
decision.
