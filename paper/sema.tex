...
Natural language gives compact names to only a small subset of reusable procedures because each additional term must be learned and remembered. A resolvable agent vocabulary relaxes that constraint: detailed definitions can be expanded on demand, allowing recurring procedures to become precise, composable terms.
...
The vocabulary and interactive graph are available at \url{https://semahash.org}. Code, paper source, vocabulary data, and release artifacts are available at \url{https://github.com/emergent-wisdom/sema}. The installable package is published at \url{https://pypi.org/project/semahash/}, and its MCP Registry entry is at \url{https://registry.modelcontextprotocol.io/servers/io.github.emergent-wisdom/semahash}. The version series is archived at \href{https://doi.org/10.5281/zenodo.19548971}{doi:10.5281/zenodo.19548971}.
